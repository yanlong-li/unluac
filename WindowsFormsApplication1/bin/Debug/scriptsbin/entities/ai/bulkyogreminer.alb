...
BulkyOgreMiner_x = {
  ...
  Properties = {
    voiceType = "enemy",
    fileModel = "Objects/Characters/monster/bulky_ogre_miner/bulky_ogre_miner.chr",
...
function BulkyOgreMiner_x:Kill(ragdoll, shooterId, weaponId, freeze)
  BasicActor.Kill(self, false, shooterId, weaponId, freeze)
  return true
end
function BulkyOgreMiner_x:HealthChanged()
...
CreateActor(BulkyOgreMiner_x)
BulkyOgreMiner = CreateAI(BulkyOgreMiner_x)
