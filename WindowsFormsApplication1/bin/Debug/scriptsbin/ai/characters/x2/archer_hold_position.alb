AICharacter.archer_hold_position = {
  ...
  Constructor = function(self, entity)
    ...
    entity.AI.param = {
      ...
      preferedCombatDist = entity.Properties.Perception.sightrange,
      maxMakeAGapCount = 3
    }
  ...
  spawning = {},
  hold_position = {
    OnAggroTargetChanged = "archer_attack",
