...
Test_HumanoidActor = {
  ...
  AnimationGraph = "player_full_body_nuian_male.xml",
  UpperBodyGraph = "player_upper_body_nuian_male.xml",
  Properties = {
    voiceType = "enemy",
    fileModel = "objects/Characters/nuian/male/nude/nu_m_base.cdf",
...
function Test_HumanoidActor:Kill(ragdoll, shooterId, weaponId, freeze)
  BasicActor.Kill(self, false, shooterId, weaponId, freeze)
  return true
end
function Test_HumanoidActor:HealthChanged()
...
CreateActor(Test_HumanoidActor)
Test_Humanoid = CreateAI(Test_HumanoidActor)
