...
function Switch:SpawnSwitch()
  ...
  elseif self.Properties.bTurnedOn == 1 then
  ...
  elseif self.switch:GetAngles() ~= props.Off * g_Deg2Rad then
    local rot = {
      x = 0,
      y = 0,
      z = 0
...
function Switch:CheckSmartSwitch(switch)
  ...
  if props.bUseSmartSwitch == 1 then
    ...
    if target and props[switch] ~= "" then
